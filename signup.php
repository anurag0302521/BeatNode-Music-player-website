...
if(isset($_POST['submit'])){
    ...
    if(empty(trim($name))){
        ...
        if($res){
            ...
            echo '<div id="hide" class="alert alert-success">Signup Successfully</div>';
...
<div class="container">
    <div class="row" style="margin-top:50px;">
        ...
        <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                <h2 class="text-white mb-3 mt-0">Sign-up</h2>
                <div class="mb-3 mt-2">
                ...
                <input class="btn btn-warning mt-3" name="submit" type="submit" value="Signup">
